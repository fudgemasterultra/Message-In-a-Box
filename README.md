This is a template for a new project where users can hide messages for others to find, similar to a message in a bottle. To get started, please follow these steps:
